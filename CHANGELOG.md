...
## [v2.4.0] - 2026-06-28 (เวอร์ชันปัจจุบัน)

### Added
- **Excel Report Export**: ปุ่ม "โหลดเป็นไฟล์ Excel" ในหน้าวิเคราะห์สถิติเยี่ยมบ้าน ส่งออกตารางสถิติตามรูปแบบเทมเพลตต้นฉบับ
- **Word Report Export**: ปุ่ม "โหลดเป็นไฟล์ Word" ในหน้าสรุปเยี่ยมบ้าน ส่งออกเอกสารสรุปข้อความและตัวเลขโดยแทนที่แท็ก placeholder จากไฟล์ต้นฉบับอย่างสมบูรณ์
- **Supabase Classroom Summary Storage**: ระบบบันทึกแบบฟอร์มวิเคราะห์การเยี่ยมบ้านระบุตัวแปร 6 รายการ ลงสู่ตารางกลาง `classroom_visit_summaries` บน Supabase แยกตามสิทธิ์ห้องเรียน แทนการเก็บเฉพาะในเบราว์เซอร์
- **Custom Alert Modals**: ระบบแจ้งเตือนบันทึกผลการทำงานสำเร็จ/เกิดข้อผิดพลาด ผ่านดีไซน์ Custom Modals มรกตและมุกแดงที่สวยงามกลมกลืนกับระบบ แทนการใช้ปุ่ม Alert ของเบราว์เซอร์
